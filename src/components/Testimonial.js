  ...
  return (
    <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center 
      ...
      <div className='flex text-3xl mt-5 gap-3 text-violet-400 mx-auto'>
          <button onClick={leftShiftHandler} className='cursor-pointer hover:bg-violet-500 mb-4'>
            <FiChevronLeft/>
          </button>
          <button onClick={rightShiftHandler} className='cursor-pointer hover:bg-violet-500 mb-4'>
            <FiChevronRight/>
        </button>
      </div>
